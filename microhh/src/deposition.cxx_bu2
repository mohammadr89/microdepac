...
void Deposition<TF>::init(Input& inputin)
{
    ...
    vd_nh3   = inputin.get_item<TF>("deposition", "vdnh3", "", (TF)0.02);
...
void Deposition<TF>::exec_cross(Cross<TF>& cross, unsigned long iotime)
{
    ...
    {
        if (name == "vdnh3_veg")
            cross.cross_plane(deposition_tiles.at("veg").vdnh3.data(), name, iotime);
        else if (name == "vdnh3_soil")
            cross.cross_plane(deposition_tiles.at("soil").vdnh3.data(), name, iotime);
        else if (name == "vdnh3_wet")
            cross.cross_plane(deposition_tiles.at("wet").vdnh3.data(), name, iotime);
    }
}
