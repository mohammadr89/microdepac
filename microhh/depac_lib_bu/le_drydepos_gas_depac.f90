...
subroutine DryDepos_Gas_DEPAC( compnam, day_of_year, lat, t, ust, glrad, sinphi, rh, &
                                 ...
                                 calc_stom_o3flux, frac_sto_o3_lu, fac_surface_area_2_PLA ) ! bind(C, name="drydepos_gas_depac")
...
laimax = lai_par(lu)%laimax !sets the laimax variable to the maximum Leaf Area Index value for the current land use type. 
