...
xsize = 11136  # Changed from 3200
ysize = 5568   # Changed from 3200
zsize = 2880   # Changed from 3200

# EDITED: Updated grid points as requested
itot = 32     # Changed from 32
jtot = 32      # Changed from 32
ktot = 32     # Changed from 32
...
if (sw_land_surface):
    ...
    grass_in_end = (26 // blocksize_i) * blocksize_i      # Align to block boundary (near 1508m)
    forest_end = (112 // blocksize_i) * blocksize_i       # Align to block boundary (near 6496m)
    ...
    crosslist = ['u', 'v', 'w', 'flux_nh3', 'norm_conc']
