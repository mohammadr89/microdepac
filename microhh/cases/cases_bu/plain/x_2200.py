...
for i in range(360):
	...
	# Get density
	rho = nc_def.groups['thermo'].variables['rho'][i,:]  # time=0, rho shape is (32,)
	# Calculate for x=1100m forest entry
	u_1100 = nc_u.variables['u'][i, :, :, 1]  # x=1100m, u shape is (32,32)
	nh3_1050 = nc_nh3.variables['nh3'][i, :, :, 0]  # NH3 at x=1050, shape is (32,32)
	nh3_1150 = nc_nh3.variables['nh3'][i, :, :, 1]  # NH3 at x=1150, shape is (32,32)
	...
	u_2200 = nc_u.variables['u'][i, :, :, 4]  # x=2200m, u shape is (32,32)
	nh3_2150 = nc_nh3.variables['nh3'][i, :, :, 3]  # NH3 at x=2150, shape is (32,32)
	nh3_2250 = nc_nh3.variables['nh3'][i, :, :, 4]  # NH3 at x=2250, shape is (32,32)
