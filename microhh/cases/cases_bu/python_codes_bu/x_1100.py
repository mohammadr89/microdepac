...
x_target = 1100  # Target x location

# Get x coordinates for NH3
nh3_x = nh3_yz_nc.variables['x'][:]

# Find NH3 interpolation points (1050 and 1150)
x1 = 1050  # First NH3 x point
x2 = 1150  # Second NH3 x point
...
# Linear interpolation for NH3 at x=1100
