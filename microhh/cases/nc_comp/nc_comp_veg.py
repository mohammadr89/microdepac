...
depac_file = 'vdnh3_veg.xy_depac.nc'
ifs_file = 'vdnh3_veg.xy_ifs.nc'
...
difference = ds_depac['vdnh3_veg'] - ds_ifs['vdnh3_veg']
...
difference.to_netcdf('vdnh3_veg_difference.nc')
