...
depac_file = 'vdnh3_wet.xy_depac.nc'
ifs_file = 'vdnh3_wet.xy_ifs.nc'
...
difference = ds_depac['vdnh3_wet'] - ds_ifs['vdnh3_wet']
...
difference.to_netcdf('vdnh3_wet_difference.nc')
