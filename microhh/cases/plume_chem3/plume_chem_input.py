# Scenario: Homogeneous Grassland 
# Domain Size: ... km (x) × ... km (y) × ... km (z)
# Species: NH3 (Background Concentration: 1e-9 mol/mol)
# Point Source: None
...
if (sw_chemistry):
    ...
    # Add total_flux_nh3 variable
    add_nc_var('total_flux_nh3', ('z'), nc_group_init, np.zeros(ktot, dtype=np.float64))
...
if (sw_land_surface):
    ...
    def set_value(variable, forest, grass):
        ...
        #ls[variable][ mask] = grass     # Homogeneous grass
    ...
    crosslist = ['u', 'flux_nh3', 'total_flux_nh3']
