Title: MicroHH-DEPAC v1.0.0: Coupling of MicroHH Large Eddy Simulation with DEPAC Dry Deposition Module
Description:
This release contains the source code used in:

Rashidi, M., Krol, M. C., and van Zanten, M. C.: Coupling of MicroHH large eddy simulation with DEPAC dry deposition module, Geoscientific Model Development, 2025.
...
Modified CMakeLists for mixed-language compilation
