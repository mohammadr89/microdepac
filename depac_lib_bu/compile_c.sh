...
gfortran -c -fPIC -cpp -ffree-line-length-none lai_calculator.f90

# Create shared library
gfortran -shared -o libdepac.so go.o le_drydepos_gas_depac.o wrapper_depac.o lai_calculator.o
...
g++ -o depac main.o -L. -ldepac -lgfortran
